...
CREATE TABLE IF NOT EXISTS `building` (
  ...
  `trash` decimal(10,0) DEFAULT NULL,
  `electric` decimal(10,0) DEFAULT NULL,
  `gas` decimal(10,0) DEFAULT NULL,
  `total_util` decimal(10,0) DEFAULT NULL,
  `total_sqft` decimal(10,0) DEFAULT NULL,
  `base_rent` decimal(10,0) DEFAULT NULL,
  `renter_insurance` decimal(10,0) DEFAULT NULL,
...
(1, 'Cutlas Corp', 40, 20, 15, 25, 10, 100, 500, 350, 50);
